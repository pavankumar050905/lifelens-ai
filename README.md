👋 Hi, this is LifeLens AI — a fully multimodal assistant powered by Google Gemini.

Let me show you how it helps in real-life situations.

---

# 🎥 Demo Video (No login required)
https://drive.google.com/file/d/14Cmd14JZKFngBWzDTjV1_DRS98y6xHHl/view?usp=drive_link

---

📸 **1. Damage Photo Analysis**
I’ll start by uploading a photo of a broken device.  
...
🍽️ **2. Food Photo → Calories + Nutrition**
Now let’s analyze a food photo.  
...
🎙️ **4. Voice Input + Spoken Output**
I can ask LifeLens questions with my microphone, and the AI responds in natural audio using Gemini’s speech output.
...
🎯 **Conclusion**
LifeLens AI brings together vision, audio, nutrition, health, and repair assistance — all in a single experience powered by Google Gemini.
